...
\addcontentsline{toc}{subsection}{\ExerciseListName\ExerciseHeaderNB : \ExerciseHeaderTitle\ExerciseHeaderOrigin}
}
...
\usepackage{etoolbox}
\makeatletter
\patchcmd{\@maketitle}{\LARGE \@title}{\fontsize{26}{19.2}\selectfont\@title}{}{}
\makeatother
...
\addcontentsline{toc}{section}{SMILEI namelists}

\subsection*{\texttt{TP\_proj1.py}}
\lstinputlisting{TP_proj1.py}

\newpage
\subsection*{\texttt{TP\_proj2.py}}
